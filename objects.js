...
const firstName = "Annemieke";
const lastName = "Segers";
let age = 37;
const dateOfBirth = new Date(1984, 06, 20);

// ===  Opdracht 2 ===
// Zorg ervoor dat de volgende string in de terminal wordt gelogd:
// "Hoi! Ik ben <voornaam>, ik ben <leeftijd> jaar oud."
console.log("Hoi ik ben " + firstName + ", en ik ben " + age + " jaar oud.");
...
product.description = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1];
